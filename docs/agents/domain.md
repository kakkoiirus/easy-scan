...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-fully-client-side-no-backend.md
│   ├── 0002-opencv-in-web-worker.md
│   └── 0003-storage-opfs-only-no-database.md
└── src/
```
...
> _Contradicts ADR-0001 (fully client-side, no backend) — but worth reopening because…_
